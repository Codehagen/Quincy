 ...
 *
 * Two decisions here are the whole "make it ours" answer:
 *
 * **No rainbow tracks.** Giving every lane its own saturated hue — purple
 * captions, blue b-roll, green audio, orange zoom — works in a
