 ...
 * Rendering the page from fields and then letting somebody edit the rendered
 * prose is how "1 posts/day" ends up on screen, and how a reworded sentence can
 * quietly move a schedule. Here the fields are the
