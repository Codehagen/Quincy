...
the general case: "An MCP endpoint. Filing it here is a category error: it is
an API surface, not a thing that hands over material." Concretely, it is
...
against a two-state checkmark. They now have somewhere to live.
