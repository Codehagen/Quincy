 ...
 * boundary wrong produces one Integrations grid holding outputs, inputs and
 * chat surfaces together, filed under "Core" and "Other" — a wall of tiles
 * where the only state a connected one carries is a checkmark.
 *
 ...
 * - **An MCP endpoint.** Filing it here is a category error: it is an API
 ...
 *
 * Four states, not two. "Connected" and "not connected" is what a checkmark
 * expresses, and it cannot express the two cases that
