 ...
 *
 * Stanley has no equivalent. Their Ideate is an empty chat box and their Write
 * is a draft already bound to a platform tab, so a half-formed thought is
 * either an ephemeral message or an obligation — nothing holds it in between.
 * And because they file inputs as "integrations" rather than sources, a draft
 * there cannot say where it came from either.
 *
