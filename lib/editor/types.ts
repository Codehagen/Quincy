 ...
 *
 * Shape is adapted from what Stanley Studio actually stores, with two
 * deliberate departures documented at their definitions: integer microseconds
...
/* ── Animation ────────────────────────────────────────────────────────────
   Stanley stores a binding table mapping a property path to channel ids, then
   the channels separately. That indirection buys multi-component properties
   (a position with x and y under one binding), and costs a join on every read.
...
/* ── Provenance ───────────────────────────────────────────────────────────
   ...
   Stanley surfaces this in the UI — their stylesheet carries a
   `--timeline-provenance-agent` colour — so it is load-bearing, not metadata.
   ──────────────────────────────────────────────────────────────────────── */
 ...
 * Stanley does, and the honest version of the tradeoff: the timeline goes
