...
/* ── Filmstrip ────────────────────────────────────────────────────────────
   ...
   alone: the reference editor's spine is a canvas, so its pixels were read
...
/** 16:9 at that height — 78px in the lane, against the reference's 79. */
...
/**
 * `xxh3-128:<bytes>:<hash>` — the same shape Stanley uses, and the reason a
