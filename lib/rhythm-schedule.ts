 ...
 * a stored UTC hour cost once already. Stanley's rituals page — the thing this
 * was measured against — stores cron and pins every tenant to UTC, so a 2:00 PM
 * ritual fires at 16:00 for a user in Oslo. That is the bug this file exists
 * not to have.
 */
