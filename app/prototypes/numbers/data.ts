...
export const POSTS: Post[] = [
  ...
  {
    id: "1995366192605720631",
    at: "2025-12-01",
    impr: 3653,
    likes: 48,
    replies: 8,
    marks: 10,
    body: "Almost hit my Vercel limits on Hagenkit this month\n\nEdge requests at 991K out of 1M\n\nUpgrading the plan before December ends\n\nProject is growing faster than I expected ✨",
  },
  {
    id: "2008438348633792878",
    at: "2026-01-06",
    impr: 3560,
    likes: 9,
    replies: 2,
    marks: 2,
    body: "Just used Ultracite from @haydenbleasel and the DX is off the charts\n\nWell played sir ✨",
  },
  {
    id: "2015130809145889269",
    at: "2026-01-24",
    impr: 3549,
    likes: 11,
    replies: 7,
    marks: 13,
    body: "Looking for a good MCP for SEO - Anyone got something to recommend ✨",
  },
  {
    id: "1995032361235251680",
    at: "2025-11-30",
    impr: 3250,
    likes: 37,
    replies: 4,
    marks: 16,
    body: "Most people know me for open source projects\n\nBut I've also been running a VC fund on the side ✨\n\nNot Another VC - I invest in early-stage companies we want to see exist. I dont write big checks - The value is the time and commitment\n\nMy approach:\n◆ join every board\n◆ help",
  },
  {
    id: "2039435000752333163",
    at: "2026-04-01",
    impr: 2281,
    likes: 9,
    replies: 7,
    marks: 0,
    body: "Anybody else has this problem?\n\n6 mins inn, 12% used.\n\nWhat is going on? 🤯\n\n@claudeai @AnthropicAI",
  },
  {
    id: "2085301552269369417",
    at: "2026-08-06",
    impr: 1858,
    likes: 25,
    replies: 4,
    marks: 36,
    body: "My new workflow\n\n/prototype and iterate on this until we are ready. This gives you 3 examples, you pick one and do a new prototype on that.\n\n/ui-review what we have done, this goes over the screen and fixes the the paddings and margins.\n\n/ui-polish fixes",
  },
  {
    id: "2007428034031227357",
    at: "2026-01-03",
    impr: 1767,
    likes: 6,
    replies: 3,
    marks: 3,
    body: "MCP inside of Cursor i just to insane. Setup a new project in 5 minutes 🤯",
  },
  {
    id: "2017210702784516502",
    at: "2026-01-30",
    impr: 1561,
    likes: 9,
    replies: 5,
    marks: 1,
    body: "This year im documenting my life ✨\n\n(Not trying to be cool with sunglasses 😂)\n\nLooking forward to share my journey with everybody.\n\nTalked with @orcdev about content - Made me realize that i should do more video.\n\nLets gooo",
  },
  {
    id: "1996963676717236413",
    at: "2025-12-05",
    impr: 1471,
    likes: 8,
    replies: 0,
    marks: 3,
    body: "Nice work on this one @KlausCodes ✨\n\n🎮 My GitHub Wrapped 2025\n\n📊 2 086 contributions",
  },
  {
    id: "2081659029722407071",
    at: "2026-07-27",
    impr: 1390,
    likes: 23,
    replies: 8,
    marks: 6,
    body: "I launched 12 businesses before turning 30 🤯\n\nDev tools, real estate agency, clothing brand, SaaS companies, venture capital fund. Most of them failed hard.\n\nEvery project i built in silence launched to crickets. Months of work, zero users on day one.\n\nThen i started sharing",
  },
  {
    id: "2023656810926706741",
    at: "2026-02-17",
    impr: 1283,
    likes: 6,
    replies: 3,
    marks: 0,
    body: "My feed is now 90% openclaw - I need some developers in my again. Who to look at right now? ✨",
  },
  {
    id: "2013658995853005039",
    at: "2026-01-20",
    impr: 1170,
    likes: 5,
    replies: 0,
    marks: 1,
    body: "It was finally time. Looking forward to this ✨",
  },
  {
    id: "2011109286450250028",
    at: "2026-01-13",
    impr: 1059,
    likes: 16,
    replies: 6,
    marks: 2,
    body: "Ready to produce some content ✨",
  },
  {
    id: "2007564076562460675",
    at: "2026-01-03",
    impr: 978,
    likes: 12,
    replies: 3,
    marks: 7,
    body: "Still rocking Hagenkit and made some updates this holiday ✨\n\nAnd its free for everyone 🤯\n\nLaunch your new project in 2 minutes – from clicking the button to live preview 📷✨\n\nTechstack:\n🌐 App: @nextjs\n☁️ Hosting: @vercel\n🎨 UI: @shadcn\n🗂️ ORM:",
  },
  {
    id: "2007206088043790647",
    at: "2026-01-02",
    impr: 938,
    likes: 2,
    replies: 1,
    marks: 3,
    body: "This is what i have been looking for ✨",
  },
  {
    id: "2022000417044054455",
    at: "2026-02-12",
    impr: 931,
    likes: 9,
    replies: 2,
    marks: 1,
    body: "Working on my biggest project over - Can't wait to share",
  },
  {
    id: "2044703079832965512",
    at: "2026-04-16",
    impr: 850,
    likes: 1,
    replies: 0,
  ...
  {
    id: "2072016697108689354",
    at: "2026-06-30",
    impr: 848,
    likes: 10,
    replies: 0,
    marks: 2,
    body: "The Cofounder model is changing ✅\n\nUsed to think the technical cofounder was everything\n\nBut now? i'd give 50% to someone who deeply knows the space\n\nWhy:\n◆ AI makes development easier each day\n◆ the hard part is knowing what to build for the niche\n◆ domain experts see",
  },
  {
    id: "2007539714807468524",
    at: "2026-01-03",
    impr: 844,
    likes: 5,
    replies: 1,
    marks: 3,
    body: "been thinking about @garyvee 2026 trends and how they map to open source ✨\n\nthe individual empire thing is already happening:\n◆ build oss tools\n◆ get community trust\n◆ launch paid tiers or services\n◆ own your revenue\n\n@calcom did this perfectly - free oss product, commercial",
  },
  {
    id: "2007453912387694819",
    at: "2026-01-03",
    impr: 769,
    likes: 2,
    replies: 0,
    marks: 0,
    body: "Sadly true story - The way to get reach is to just be a normal person. Lets go 2026 ✨",
  },
  {
    id: "1997066203094044710",
    at: "2025-12-05",
    impr: 756,
    likes: 1,
    replies: 0,
    marks: 1,
    body: "To get updates and be first in line to test 🔗",
  },
  {
    id: "2085245526203564256",
    at: "2026-08-06",
    impr: 752,
    likes: 1,
    replies: 1,
    marks: 1,
    body: "So i found the problem for me to ship more content. Its not the lack of ideas and video (I got a lot of video content)\n\nThe problem is that i cant edit. So we need to fix that.\n\nI need to do a developer move on this one ✨",
  },
  {
    id: "2007476421245939977",
    at: "2026-01-03",
    impr: 748,
    likes: 4,
    replies: 3,
    marks: 0,
    body: "Who is founders and indie devs that i should follow? Tag them below 👇",
  },
  {
    id: "2085694443244728741",
    at: "2026-08-07",
    impr: 746,
    likes: 14,
    replies: 1,
    marks: 1,
    body: "Are you building something?\nPing me ✨",
  },
  {
    id: "2009330391291973900",
    at: "2026-01-08",
    impr: 743,
    likes: 6,
    replies: 0,
  ...
  {
    id: "2084364771009151404",
    at: "2026-08-03",
    impr: 686,
    likes: 5,
    replies: 1,
    marks: 2,
    body: 'My prediction on the new way of getting views on social media after a deep dive in the algo this weekend.\n\nAnd i predict that "Interest media" has taken over for Sosial media\n\nYour feed doesn\'t care who you follow anymore.\nIt only cares if the post is relevant right now.\n\nSame',
  },
  {
    id: "2008110965032939536",
    at: "2026-01-05",
    impr: 644,
    likes: 6,
    replies: 4,
    marks: 1,
    body: "I disconnected this holiday and here is what i got out if it\n\nNothing, working is what i love. Lets go 2026 ✨",
  },
  {
    id: "1995947431918547341",
    at: "2025-12-02",
    impr: 638,
    likes: 2,
    replies: 0,
    marks: 0,
    body: "If you want updates on products i build 🔗",
  },
  {
    id: "2083871952108765544",
    at: "2026-08-02",
    impr: 629,
    likes: 7,
    replies: 0,
    marks: 2,
    body: "New mini-project coming along. This time i did something different.\n\nBeen studying UI and what feels «right» And i want those app to be polished before the release.\n\nThe new design skills have been a big help on this ✨",
  },
  {
    id: "2085625162972496328",
    at: "2026-08-07",
    impr: 603,
    likes: 8,
    replies: 0,
    marks: 1,
    body: "Meetings are now content days ✨",
  },
  {
    id: "2009741767864717630",
    at: "2026-01-09",
    impr: 581,
    likes: 4,
    replies: 2,
    marks: 0,
    body: "Prediction: Will Tailwind join Vercel?",
  },
  {
    id: "2085663273110683970",
    at: "2026-08-07",
    impr: 577,
    likes: 5,
    replies: 2,
    marks: 3,
    body: "I sold two SaaS companies in one year while still closing real estate deals in Norway ✅\n\nNo funding round.\nNo Goldman analyst background.\nJust a broker job by day and a laptop by night.\n\nHere are the 3 things that actually moved the needle:\n\n1. Your day job is reps, not a",
  },
  {
    id: "2009582175365349758",
    at: "2026-01-09",
    impr: 554,
    likes: 2,
    replies: 0,
    marks: 1,
    body: "Does anybody want to coach me on making good content videos? ✨\n\nIn exchange I'll help you build your app\n◆ coding\n◆ architecture\n◆ whatever you need\n\nDMs are open",
  },
  {
    id: "2010450534835331558",
    at: "2026-01-11",
    impr: 530,
    likes: 2,
    replies: 1,
    marks: 0,
    body: "Looking for video creators to follow ✨\n\nWant to build better content\n\nTag them bellow 👇",
  },
  {
    id: "2010038790711111817",
    at: "2026-01-10",
    impr: 522,
    likes: 2,
    replies: 0,
    marks: 0,
    body: "Some people have written to me, but still looking for the one 🔥\n\nDoes anybody want to coach me on making good content videos? ✨\n\nIn exchange I'll help you build your app\n◆ coding\n◆ architecture\n◆ whatever you need",
  },
  {
    id: "2010067875503943844",
    at: "2026-01-10",
    impr: 509,
    likes: 5,
    replies: 2,
    marks: 1,
    body: "if you started posting everything you're interested in ✨\n\nliterally everything - your side projects, random thoughts, what you're learning, what you're building\n\nyou'd be surprised how many people want to see it\n\nthe connections happen when you just share",
  },
  {
    id: "2081365130550333696",
    at: "2026-07-26",
    impr: 492,
    likes: 3,
    replies: 1,
  ...
  {
    id: "2086030383779295741",
    at: "2026-08-08",
    impr: 378,
    likes: 2,
    replies: 0,
    marks: 1,
    body: "Codename: Quincy\n\nLaunching it in a week ✨",
  },
  {
    id: "2081365132563628460",
    at: "2026-07-26",
    impr: 358,
    likes: 1,
    replies: 0,
  ...
  {
    id: "2086181117619568797",
    at: "2026-08-08",
    impr: 287,
    likes: 5,
    replies: 1,
    marks: 1,
    body: "2410 contributions in 2025\n\n6126 so far in 2026 🤯\n\nSame builder. Different gear.\n\nWhat a time to be shipping",
  },
]
...
export const ANGLES: Angle[] = [
  ...
  },
  {
    ...
    test: (p) =>
      /^(story time|i just sold|i launched \d+|i sold)/i.test(p.body),
  },
  {
    id: "ask",
    label: "Open question",
    ...
    test: (p) =>
      /\?/.test(p.body.split("\n")[0]) ||
      /^(looking for|who is|does anybody|anybody else)/i.test(p.body),
  },
  {
    id: "link-reply",
    ...
    test: (p) =>
      /^(repo|demo|test it here|to get updates|if you want updates)/i.test(
        p.body
      ),
  },
  {
