...
/**
 * Roster won; Marquee, Stage and Ledger are deleted. The harness stays so the
 * next exploration is one import and one line here, not a rebuild — the picker,
 * the shell, the fixtures and the entrance timing are all still wired.
 */
...
export function Harness() {
  ...
  return (
    <>
      {/* The real shell, mirroring app/(app)/layout.tsx — a channels page is
          judged at the width the sidebar leaves it, not at full viewport.
          No nav row highlights: usePathname reads /prototypes/channels, and
