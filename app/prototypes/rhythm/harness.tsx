...
import { Assembly } from "./variants/assembly"

/**
 * Assembly won; Foundry and Clockwork are deleted. The harness stays so the
 * next round is one import and one line here.
 */
const VARIANTS = [{ name: "Assembly", render: () => <Assembly /> }]
