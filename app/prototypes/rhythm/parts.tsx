 ...
 * under test: drawn on a few cards it is decoration, and drawn on every rhythm
 * it becomes the index — you can scan a column for "what feeds X" without
 * reading a word.
 */
...
/**
 * The trigger, stated rather than assumed. "Daily 08:00" and
