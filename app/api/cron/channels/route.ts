 ...
 * lib/channels-maintenance.ts, and this is the part that decides whether the
 * caller is allowed to ask.
 *
...
// One HTTP request per connection, sequentially. No model calls, so this is
// headroom rather than a real expectation — but the default would truncate the
// sweep silently once there are enough rows, and a half-finished sweep reports
// success.
